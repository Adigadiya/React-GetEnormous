...
export default function Generator(props) {
    ...
    return (
        <SectionWrapper id={'generate'} title={['Generate your workout']}>
            <Header index={'01'} title={'Pick Split'} description={"Select the workout split of your choice."} />
            ...
            <Header index={'02'} title={'Lock In'} description={"Select the target muscles."} />
            ...
            <Header index={'03'} title={'End Goal'} description={"Select your ultimate objective."} />
